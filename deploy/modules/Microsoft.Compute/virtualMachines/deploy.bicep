...
@description('Optional. The name of the computer.')
...
var vmComputerNameTransformed = vmComputerNamesTransformation == 'uppercase' ? toUpper(computerName) : (vmComputerNamesTransformation == 'lowercase' ? toLower(computerName) : computerName)
